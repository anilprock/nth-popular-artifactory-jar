...
public class StandaloneInteractiveHandler {

    private static final Logger logger = Logger.getLogger(StandaloneInteractiveHandler.class.getName());
    ...
    public StandaloneInteractiveHandler(HelpFormatter helpFormatter) {
    ...
    public Options configureOptions() {
        ...
        options.addOption("u", "url", true, "Artifactory url in format http://host:port/artifactory or https://host:port/artifactory");
        options.addOption("r", "repo", true, "Repository to search for the nth Artifactory popular jar files");
        options.addOption("a", "auth", true, "Artifactory API authentication token");
    ...
    public static void main(String args[]) {
    	StandaloneInteractiveHandler handler = new StandaloneInteractiveHandler(new HelpFormatter());
